  ...
  const navigation = [
    {
      ...
      items: [
        ...
        { name: "Campaigns", href: "/admin/campaigns", icon: "campaigns", current: pathname.startsWith("/admin/campaigns") },
        { name: "Donations", href: "/admin/donations", icon: "donations", current: pathname.startsWith("/admin/donations") },
        { name: "Payouts", href: "/admin/payouts", icon: "payouts", current: pathname.startsWith("/admin/payouts") },
        { name: "Hospitals", href: "/admin/hospitals", icon: "hospitals", current: pathname.startsWith("/admin/hospitals") },
    ...
    },
    {
      name: "REPORTS",
      items: [
        { name: "Analytics", href: "/admin/analytics", icon: "analytics", current: pathname.startsWith("/admin/analytics") },
        { name: "Audit Logs", href: "/admin/audit-logs", icon: "audit", current: pathname.startsWith("/admin/audit-logs") },
      ]
    },
    {
      name: "MANAGEMENT",
