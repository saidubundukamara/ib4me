  ...
  try {
    ...
    switch (category) {
      ...
      default:
        ...
        const [website, payment, features, contact, social, seo] = await Promise.all([
...
export async function PUT(request: NextRequest) {
  try {
    ...
    switch (category) {
      case "website":
        updatedSettings = await settingService.updateWebsiteSettings(body, adminContext.adminId.toString());
        break;
      case "payment":
        updatedSettings = await settingService.updatePaymentSettings(body, adminContext.adminId.toString());
        break;
      case "features":
        updatedSettings = await settingService.updateFeatureSettings(body, adminContext.adminId.toString());
        break;
      case "contact":
        updatedSettings = await settingService.updateContactSettings(body, adminContext.adminId.toString());
        break;
      case "social":
        updatedSettings = await settingService.updateSocialSettings(body, adminContext.adminId.toString());
        break;
      case "seo":
        updatedSettings = await settingService.updateSeoSettings(body, adminContext.adminId.toString());
        break;
      default:
