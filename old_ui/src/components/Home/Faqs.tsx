...
function FAQItem({ question, answer, index }: FAQItemProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group rounded-lg border-[0.5px] border-neutral-200/50 dark:border-neutral-800/50',
        'transition-all duration-200 ease-in-out',
        isOpen
          ? 'bg-linear-to-br from-white via-neutral-50/50 to-white dark:from-white/5 dark:via-white/2 dark:to-white/5'
      ...
      >
        <h3
          className={cn(
            ...
            isOpen && 'text-neutral-900 dark:text-white',
          )}
        >
          {question}
        </h3>
        <motion.div
          ...
          className={cn(
            ...
            isOpen ? 'text-primary' : 'text-neutral-400 dark:text-neutral-500',
          )}
        >
...
const Faqs = () => {
  ...
  return (
    <section className="py-16 w-full bg-linear-to-b from-transparent via-neutral-50/50 to-transparent dark:from-transparent dark:via-white/[0.02] dark:to-transparent">
      <div className="container px-4 mx-auto">
        ...
        >
          <h2 className="text-3xl font-semibold mb-3 bg-linear-to-r from-neutral-900 via-neutral-800 to-neutral-900 dark:from-white dark:via-neutral-100 dark:to-white bg-clip-text text-transparent">
